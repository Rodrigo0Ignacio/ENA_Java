 ...
 * @author Rodrigo
 */
public class ConsultarR extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // capturamos las variables del consultaRequerimiento.jsp
        ...
        if(asignar.contentEquals("Seleccionar")){
         ...
         if( !errores.isEmpty()){
             ...
             request.getRequestDispatcher("consultarRequerimiento.jsp").forward(request, response);
           
        } else
        // mandamos los datos al metodo Buscar Requerimiento
        
        tabla =  con.BuscarRequerimiento(gerencia, departamento, asignar);
        
       // devolvemos el "resultado" del metodo a la pagina
